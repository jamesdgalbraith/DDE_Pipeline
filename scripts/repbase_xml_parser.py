          ...
          for child_3 in child_2:
            for child_4 in child_3:
              if child_4.tag == "Hit_def":
                Hit_id = child_4.text.split()[0]
                Hit_class = child_4.text.split()[1]
                Hit_species = re.sub(" ", "_", child_4.text.split("   ")[2])
              ...
              for hsp in child_4:
                ...
                tsv_writer.writerow([Iteration_query_ID, Hit_id, perc_iden, Hsp_align_len, mismatch, Hsp_gaps, Hsp_query_from, Hsp_query_to, Hsp_hit_from, Hsp_hit_to, Hsp_evalue, Hsp_bit_score, Hit_species, iteration, Iteration_query_len, re.sub("-", "", Hsp_hseq), Hit_class])
